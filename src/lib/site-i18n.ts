...
export const siteCopy = {
  en: {
      ...
      how: {
        ...
        workflow: [
          ...
          },
          {
            ...
            body: "Pay $197 to open the complete brand diagnosis with positioning, tone, visual identity, fixes, and rewrite suggestions.",
          },
        ],
      },
      fullReport: {
      ...
      offers: {
        ...
        rows: [
          ...
          },
          {
            ...
            price: "$197",
            summary:
              "The full paid report: positioning, tone, visual identity, above-the-fold audit, friction map, priority fixes, and 3 rewrite suggestions.",
    ...
    firstRead: {
      ...
      unlockBusy: "Redirecting to checkout...",
    ...
    fullReport: {
      ...
      mechanicBody:
        "This route is the paid BrandMirror layer. Checkout unlocks the full report and its PDF export.",
      unlockLabel: "Unlock logic",
      unlockTitle: "Unlock the full BrandMirror report.",
      unlockBody:
        "Pay once to open the full diagnostic, then export the report as PDF.",
      websiteUrl: "Website URL",
      urlPlaceholder: "yourbrand.com",
      submitIdle: "Generate full report",
      submitBusy: "Building report...",
      checkoutIdle: "Unlock full report — $197",
      checkoutBusy: "Redirecting to checkout...",
      statusInitial: "Enter a website to unlock the full report.",
      statusBusy: "Building the full BrandMirror report.",
      statusDone: "Full BrandMirror report generated.",
      paymentUnlockedStatus: "Payment confirmed. Building the full report.",
      emptyUrl: "Enter a website URL to generate the full report.",
      paymentRequiredError: "Complete checkout to unlock the full report.",
      paymentVerifyError:
        "We couldn't verify payment for this report. Try returning from checkout again.",
  ...
  es: {
    landing: {
      ...
      how: {
        ...
        workflow: [
          ...
          { step: "03", title: "Desbloquea el reporte completo", body: "Paga $197 para abrir el diagnóstico completo con posicionamiento, tono, identidad visual, fixes y rewrite suggestions." },
        ],
      },
      fullReport: {
    ...
    firstRead: {
      ...
      unlockTestPdfBusy: "Generando PDF del reporte completo...",
      unlockCta: "Desbloquear reporte completo — $197",
      unlockBusy: "Redirigiendo al checkout...",
    ...
    fullReport: {
      ...
      mechanicBody:
        "Esta ruta es la capa pagada de BrandMirror. El checkout desbloquea el reporte completo y su exportación PDF.",
      unlockLabel: "Lógica de desbloqueo",
      unlockTitle: "Desbloquea el reporte completo de BrandMirror.",
      unlockBody:
        "Paga una vez para abrir el diagnóstico completo y luego exportarlo como PDF.",
      websiteUrl: "URL del sitio web",
      urlPlaceholder: "tu-marca.com",
      submitIdle: "Generar reporte completo",
      submitBusy: "Construyendo reporte...",
      checkoutIdle: "Desbloquear reporte completo — $197",
      checkoutBusy: "Redirigiendo al checkout...",
      statusInitial: "Ingresa un sitio web para desbloquear el reporte completo.",
      statusBusy: "Construyendo el reporte completo de BrandMirror.",
      statusDone: "Reporte completo de BrandMirror generado.",
      paymentUnlockedStatus: "Pago confirmado. Construyendo el reporte completo.",
      emptyUrl: "Ingresa un sitio web para generar el reporte completo.",
      paymentRequiredError: "Completa el checkout para desbloquear el reporte completo.",
      paymentVerifyError:
        "No pudimos verificar el pago de este reporte. Intenta volver desde checkout otra vez.",
  ...
  ru: {
    landing: {
      ...
      how: {
        ...
        workflow: [
          ...
          { step: "03", title: "Открой полный отчёт", body: "Заплати $197 и открой полный диагноз бренда: позиционирование, тон, визуальная идентичность, fixes и rewrite suggestions." },
        ],
      },
      fullReport: {
        label: "Полный отчёт",
    ...
    firstRead: {
      ...
      unlockBusy: "Перенаправляю в checkout...",
    ...
    fullReport: {
      ...
      mechanicBody:
        "Этот маршрут — платный слой BrandMirror. Checkout открывает полный отчёт и его экспорт в PDF.",
      unlockLabel: "Логика разблокировки",
      unlockTitle: "Открой полный отчёт BrandMirror.",
      unlockBody:
        "Один платёж открывает полный диагностический слой и PDF-экспорт.",
      websiteUrl: "URL сайта",
      urlPlaceholder: "yourbrand.com",
      submitIdle: "Сгенерировать полный отчёт",
      submitBusy: "Собираю отчёт...",
      checkoutIdle: "Открыть полный отчёт — $197",
      checkoutBusy: "Перенаправляю в checkout...",
      statusInitial: "Введите сайт, чтобы открыть полный отчёт.",
      statusBusy: "Собираю полный отчёт BrandMirror.",
      statusDone: "Полный отчёт BrandMirror готов.",
      paymentUnlockedStatus: "Оплата подтверждена. Собираю полный отчёт.",
      emptyUrl: "Введите URL сайта, чтобы сгенерировать полный отчёт.",
      paymentRequiredError: "Завершите checkout, чтобы открыть полный отчёт.",
      paymentVerifyError:
        "Не удалось подтвердить оплату для этого отчёта. Попробуйте вернуться из checkout ещё раз.",
