...
export const siteCopy = {
  en: {
    ...
    firstRead: {
      ...
      unlockBody:
        "Unlock the complete BrandMirror diagnosis with signal read, website surface, five deep dives, commercial impact scenarios, and the implementation tools that turn this read into action.",
      included: "Included",
      unlockItems: [
  ...
  ru: {
    ...
    firstRead: {
      ...
      unlockBody:
        "Откройте полный диагноз BrandMirror: signal read, website surface, 5 deep dives, сценарии коммерческого эффекта и инструменты внедрения, которые превращают этот read в действие.",
      included: "Включено",
      unlockItems: [
        "Signal read + website surface",
