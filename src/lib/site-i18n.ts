      ...
      how: {
        ...
        workflow: [
          ...
          },
          {
            ...
            body: "Pay $197 to open the complete brand diagnosis with positioning, AI visibility, visual identity, ROI scenarios, competitor comparison, and the implementation playbook.",
          },
        ],
      },
      fullReport: {
    ...
    landing: {
      ...
      how: {
        ...
        workflow: [
          ...
          { step: "03", title: "Desbloquea el reporte completo", body: "Paga $197 para abrir el diagnóstico completo con posicionamiento, visibilidad en IA, identidad visual, escenarios de ROI, comparación con competidores y el implementation playbook." },
        ],
      },
      fullReport: {
    ...
    landing: {
      ...
      how: {
        ...
        workflow: [
          ...
          { step: "03", title: "Открой полный отчёт", body: "Заплати $197 и открой полный диагноз бренда: позиционирование, AI visibility, визуальная идентичность, ROI-сценарии, сравнение с конкурентами и implementation playbook." },
        ],
      },
      fullReport: {
        label: "Полный отчёт",
