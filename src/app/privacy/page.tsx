...
export const metadata: Metadata = {
  ...
  description:
    "How BrandMirror collects and uses email addresses, submitted website URLs, report data, and payment-related information.",
  alternates: {
    canonical: "/privacy",
  },
};
...
export default async function PrivacyPage({
  ...
  const copy = legalPageCopy[locale].privacy;
      ...
      <div className="mx-auto max-w-5xl">
        <header className="editorial-rule flex flex-col gap-5 py-5 sm:flex-row sm:items-end sm:justify-between">
          ...
          <div className="flex items-center gap-3">
            ...
            >
              {legalPageCopy[locale].terms.title}
            </Link>
